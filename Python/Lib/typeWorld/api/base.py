        ...
        def my_replace(match):
            ...
            if '.' in match:
                ...
                if '()' in attributeName:
                    ...
                    match = '[%s.%s()](#class_%s_method_%s)' % (className, attributeName, className, attributeName)
                else:
                    match = '[%s.%s](#class_%s_attribute_%s)' % (className, attributeName, className, attributeName)
            else:
                className = match
                match = '[%s](#class_%s)' % (className, className)
