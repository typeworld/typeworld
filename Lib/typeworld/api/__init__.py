...
class DictBasedObject(object):
    ...
    def typeDescription(self, class_):
        ...
        elif class_.dataType in (dict, list, tuple, str, bytes, set, frozenset, bool, int, float):
...
#                values = list(set(values))
        ...
        # Check custom messages:
        if issubclass(self.__class__, BaseResponse) and hasattr(self, 'customValidation') and isinstance(self.customValidation, types.MethodType):
...
class Font(DictBasedObject):
    ...
    _structure = {
        ...
        'languageSupport':  [LanguageSupportDataType,False,     None,   'Dictionary of suppported languages as script/language combinations'],
    }
