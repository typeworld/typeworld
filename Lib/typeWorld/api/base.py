...
INSTALLABLEFONTSCOMMAND = {
    ...
    'responseTypes': [SUCCESS, ERROR, NOFONTSAVAILABLE, INSUFFICIENTPERMISSION, TEMPORARILYUNAVAILABLE, VALIDTYPEWORLDUSERACCOUNTREQUIRED, ACCESSEXPIRED],
    'acceptableMimeTypes': ['application/json'],
    }
INSTALLFONTCOMMAND ={
    'keyword': 'installFont',
    'currentVersion': VERSION,
    'responseTypes': [SUCCESS, ERROR, UNKNOWNFONT, INSUFFICIENTPERMISSION, TEMPORARILYUNAVAILABLE, DUPLICATEINSTALLATION, SEATALLOWANCEREACHED, VALIDTYPEWORLDUSERACCOUNTREQUIRED, REVEALEDUSERIDENTITYREQUIRED, ACCESSEXPIRED],
    'acceptableMimeTypes': ['application/json'],
    }
UNINSTALLFONTCOMMAND =  {
    'keyword': 'uninstallFont',
    'currentVersion': VERSION,
    'responseTypes': [SUCCESS, ERROR, UNKNOWNFONT, UNKNOWNINSTALLATION, INSUFFICIENTPERMISSION, TEMPORARILYUNAVAILABLE, VALIDTYPEWORLDUSERACCOUNTREQUIRED, ACCESSEXPIRED],
    'acceptableMimeTypes': ['application/json'],
    }
