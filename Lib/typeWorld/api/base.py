...
INSTALLFONTCOMMAND ={
    'keyword': 'installFont',
    'currentVersion': VERSION,
    'responseTypes': [SUCCESS, ERROR, UNKNOWNFONT, INSUFFICIENTPERMISSION, TEMPORARILYUNAVAILABLE, DUPLICATEINSTALLATION, SEATALLOWANCEREACHED, VALIDTYPEWORLDUSERACCOUNTREQUIRED, REVEALEDUSERIDENTITYREQUIRED],
    'acceptableMimeTypes': ['application/json'],
    }
UNINSTALLFONTCOMMAND =  {
    'keyword': 'uninstallFont',
    'currentVersion': VERSION,
    'responseTypes': [SUCCESS, ERROR, UNKNOWNFONT, UNKNOWNINSTALLATION, INSUFFICIENTPERMISSION, TEMPORARILYUNAVAILABLE, VALIDTYPEWORLDUSERACCOUNTREQUIRED],
    'acceptableMimeTypes': ['application/json'],
    }
SETANONYMOUSAPPIDSTATUSCOMMAND =  {
    'keyword': 'setAnonymousAppIDStatus',
    'currentVersion': VERSION,
    'responseTypes': [SUCCESS, ERROR, INSUFFICIENTPERMISSION, TEMPORARILYUNAVAILABLE],
    'acceptableMimeTypes': ['application/json'],
    }
